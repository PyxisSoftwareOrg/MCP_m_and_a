...
Each acquisition target requires a customized sales plan with three key components:

| Component | Elements | Description |
|-----------|----------|-------------|
| **Company Profile** | Qualification Scores<br>Likelihood Assessment<br>Strategic Fit<br>Key Contacts | Q1-Q5 detailed breakdown<br>Transaction readiness factors<br>VMS alignment and synergies<br>Decision makers and influencers |
| **Engagement Strategy** | Value Proposition<br>Content Strategy<br>Relationship Mapping<br>Timeline | Tailored messaging<br>Industry-specific materials<br>Contact hierarchy and approach<br>12-month engagement roadmap |
| **Activity Expectations** | BD Activities<br>Executive Activities<br>Success Metrics<br>Review Cadence | Monthly targets and KPIs<br>Quarterly goals and metrics<br>Advancement milestones<br>Progress assessment schedule |\n\n### Investment Thesis Generation\n\n#### AI-Powered Thesis Development\n- **Agent Training**: Specialized ChatGPT Pro agent for investment analysis\n- **Data Integration**: Pull core company data from Salesforce\n- **Thesis Components**: Strategic rationale, synergies, valuation framework\n- **Executive Review**: Guided suggestions for investment committee\n\n#### Thesis Framework Elements
